...
>
> 例えば、重みが 1 の$250 のコンバージョンは、$250 とレポートされます。 コンバージョン指標に 0.5 の重みが割り当てられている場合、Advertising Cloudでは$250 のコンバージョンが$125（$250 コンバージョン* 0.5）としてレポートされます。 [!UICONTROL Property Weight] = 125 ドル )。
...
>
> 例えば、10 件の「アプリケーション送信」コンバージョンが追跡される場合、10 件の「アプリケーション送信」コンバージョンがレポートされます。  コンバージョン指標に 0.5 の重みが割り当てられている場合、10 個のコンバージョンは、Advertising Cloud（10 個のコンバージョン* 0.5）で 5 としてレポートされます。 [!UICONTROL Property Weight] = 5)。
